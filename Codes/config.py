...
class config:
    ...
    def __init__(self):
            ...
            self.show_imgs_while_train = False  
            ...
            self.anchor_box_scales = [16, 32, 64] # For multiscale detection
            ...
            # overlaps for RPN
            self.rpn_min_overlap = 0.3 # this was 0.3
            self.rpn_max_overlap = 0.7

            # overlaps for classifier ROIs
            self.classifier_min_overlap = 0.1 # this was 0.1
            self.classifier_max_overlap = 0.5

            # placeholder for cls_mapping, automatically generated by the parser
